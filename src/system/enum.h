...
namespace enumeration {
  ...
  typedef enum E_SHAPE {
    SHAPE_MIN,
      ...
      SHAPE_BOX_MIN=SHAPE_SPHERE_MAX,
        ...
        BLOCK_2_4_2_SHAPE,
        BLOCK_5_1_5_SHAPE,
        BLACK_HOLE_GHOST_SHAPE,
        SHAPE_SHIFTER_GHOST_SHAPE,
      SHAPE_BOX_MAX,
      SMALL_CYLINDER,
      SMALL_CONE,
    SHAPE_MAX
  ...
  typedef enum E_WorldObjType {
      ...
      DUMMY_SPHERE, BALLHEMOTH, BLACK_HOLE, BLACK_HOLE_GHOST,
      DUMMY_CYLINDER, DUMMY_CONE, CUSTOM_BLOCK, DRILL_CONE,
      FRACTAL_BOMB, WARPED_CUBE, RECOGNIZER, SMOOTH, TWIST, BUSTER,
      AIR_STRIKE, SHOTGUN, SHAPE_SHIFTER, SHAPE_SHIFTER_GHOST, CLUSTER_BOMB,
      TYPE_MAX
  } ObjectType;
